...
<div class="category-con">
	<div class="workArea">
		...
		<div class="category-tab-content">
			<ul class="normal-nav">
				<c:forEach items="${requestScope.categoriesAndProduct.categoryOnes}"
					var="c">
...
<div class="new-floor-con">
	<div class="workArea">
		<c:forEach items="${requestScope.categoriesAndProduct.categoryOnes}"
			var="c">
			<c:set var="key" value="${c.categoryOneId }" />
			<c:if
				test="${!empty requestScope.categoriesAndProduct.productes[key]}">
				<div class="floor-line-con">
					<i class="color-mark"></i>
					<div class="floor-name">${c.categoryOneName}</div>
					<br>
					<c:forEach
						items="${requestScope.categoriesAndProduct.productes[key]}"
						var="p">
						<a class="grid" href="showProduct?product_id=${p.productId}">
							<div class="productItem">
								<!-- <img class="floor-item-img" src="img/product/p.productId}/1.jpg"> -->
