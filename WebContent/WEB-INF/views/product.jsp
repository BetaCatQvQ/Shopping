<%@page import="com.shopping.entity.ProductType"%>
...
div.infoInimgAndInfo div.productPriceDiv {
	background-image: url(/Shopping/img/fore/priceBackground.png);
	height: 85px;
	padding: 10px;
	color: #666666;
}
...
<script>
    $(function () {
        ...
        var stock = ${defaultProduct.restQuantity};
		...
		*/
        function addCart() {
            ...
            $.post(addCartpage, {"ptId": product_id, "quantity": num ,"ajax":""},
            	function (data) {
                	if (data > 0) {
        ...
        $(".addCartLink").click(function () {
        	$.post("${ctx}/user/checkLogin.action",function(data){
        		if(data > 0){
        			...
        			location.href="${ctx}/user/login.action";
        		}
        	});
		});
    });
