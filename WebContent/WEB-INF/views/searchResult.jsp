		...
		<c:forEach items="${requestScope.page.data}" var="p">
			<div class="product">
				<div class="product-iWrap">
					<div class="productImg-wrap">
						<a class="productImg"
							href="/showProduct?product_id=${p.productTypeId}"> <img
							src="${pageContext.request.contextPath }${p.productImagePath}">
						</a>
					</div>
					<div style="clear: both;"></div>
					<p class="productPrice">
						<em title="${p.minPrice}"> <b>￥</b>${p.minPrice}
						</em>
					</p>
					<div style="clear: both;"></div>
					<p class="productTitle">
...
=======
		<c:if test="${empty requestScope.page.data}">
			<div class="nrt">
				<p>
					喵~没找到与 <em>" ${param.keywords} "</em> 相关的商品哦。
				</p>
			</div>
		</c:if>
		<div style="clear: both"></div>
